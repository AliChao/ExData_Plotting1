...
##change the Global_active_power type
...
##change the Voltage type
household1$Voltage<-as.character(household1$Voltage)
household1$Voltage<-as.numeric(household1$Voltage)
##change the Sub_metering 1-3 type
...
##change the Global_reactive_power type
household1$Global_reactive_power<- as.character(household1$Global_reactive_power)
household1$Global_reactive_power<- as.numeric(household1$Global_reactive_power)
...
with(household1,{
        ...
        plot(x=household1$Date, y=household1$Voltage,type="l",xlab="datetime",ylab="Voltage",main="")
        plot(household1$Date,household1$Sub_metering_1,type="l",xlab="",ylab="Energy sub metering")
                ...
                legend("top", col=c("black","red","blue"), legend= c("Sub_metering_1","Sub_metering_2","Sub_metering_3"),lty = 1,lwd = 1,cex=0.6, bty="n")
        plot(x=household1$Date, y=household1$Global_reactive_power,type="l",ylab="Global_reactive_power",xlab="datetime",main="")
})